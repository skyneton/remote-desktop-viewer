...
namespace RemoteDesktopViewer.Utils
{
    ...
    {
        public static void RunAsDesktopUser(string fileName, string argument)
        {
            ...
            try
            {
                ...
                if (!CreateProcessWithTokenW(hPrimaryToken, 0, fileName, argument, 0, IntPtr.Zero, Path.GetDirectoryName(fileName), ref si, out pi))
                    return;
            }
            finally
            {
